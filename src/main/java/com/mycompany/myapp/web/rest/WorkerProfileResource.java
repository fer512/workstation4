...
public class WorkerProfileResource {
    ...
    public WorkerProfileResource(WorkerProfileService workerProfileService, WorkerProfileRepository workerProfileRepository) {
    ...
    public ResponseEntity<List<WorkerProfileDTO>> getAllWorkerProfiles(
        ...
        log.debug("REST request to get a page of WorkerProfiles");
        Page<WorkerProfileDTO> page;
        if (eagerload) {
            page = workerProfileService.findAllWithEagerRelationships(pageable);
        } else {
            page = workerProfileService.findAll(pageable);
        }
