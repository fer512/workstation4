...
describe('WorkerProfile Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call attencionChannel query and add missing value', () => {
      ...
      const attencionChannel: IWorkerProfileAttencionChannel = { id: 30480 };
      workerProfile.attencionChannel = attencionChannel;

      const attencionChannelCollection: IWorkerProfileAttencionChannel[] = [{ id: 81996 }];
    ...
    it('Should call Company query and add missing value', () => {
      const workerProfile: IWorkerProfile = { id: 456 };
      const company: ICompany = { id: 62602 };
      workerProfile.company = company;

      const companyCollection: ICompany[] = [{ id: 84084 }];
    ...
    it('Should call Branch query and add missing value', () => {
      const workerProfile: IWorkerProfile = { id: 456 };
      const branches: IBranch[] = [{ id: 60396 }];
      workerProfile.branches = branches;

      const branchCollection: IBranch[] = [{ id: 16811 }];
    ...
    it('Should update editForm', () => {
      const workerProfile: IWorkerProfile = { id: 456 };
      const attencionChannel: IWorkerProfileAttencionChannel = { id: 26286 };
      workerProfile.attencionChannel = attencionChannel;
      const company: ICompany = { id: 51319 };
      workerProfile.company = company;
      const branches: IBranch = { id: 54358 };
      workerProfile.branches = [branches];
