...
describe('Worker Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Company query and add missing value', () => {
      ...
      const company: ICompany = { id: 8398 };
      worker.company = company;

      const companyCollection: ICompany[] = [{ id: 10121 }];
    ...
    it('Should call Branch query and add missing value', () => {
      const worker: IWorker = { id: 456 };
      const branches: IBranch[] = [{ id: 33166 }];
    ...
    it('Should call WaitingRoom query and add missing value', () => {
      const worker: IWorker = { id: 456 };
      const waitingRoom: IWaitingRoom = { id: 94742 };
      worker.waitingRoom = waitingRoom;

      const waitingRoomCollection: IWaitingRoom[] = [{ id: 42487 }];
    ...
    it('Should update editForm', () => {
      const worker: IWorker = { id: 456 };
      const company: ICompany = { id: 38025 };
      worker.company = company;
      const branch: IBranch = { id: 47023 };
      worker.branches = [branch];
      const waitingRoom: IWaitingRoom = { id: 69528 };
      worker.waitingRoom = waitingRoom;
