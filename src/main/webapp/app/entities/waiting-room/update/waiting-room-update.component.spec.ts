...
describe('WaitingRoom Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call attencionChannel query and add missing value', () => {
      ...
      const attencionChannel: IWaitingRoomAttencionChannel = { id: 81584 };
      waitingRoom.attencionChannel = attencionChannel;

      const attencionChannelCollection: IWaitingRoomAttencionChannel[] = [{ id: 7579 }];
    ...
    it('Should call Company query and add missing value', () => {
      const waitingRoom: IWaitingRoom = { id: 456 };
      const company: ICompany = { id: 61068 };
      waitingRoom.company = company;

      const companyCollection: ICompany[] = [{ id: 92216 }];
    ...
    it('Should call Branch query and add missing value', () => {
      const waitingRoom: IWaitingRoom = { id: 456 };
      const branches: IBranch[] = [{ id: 36747 }];
      waitingRoom.branches = branches;

      const branchCollection: IBranch[] = [{ id: 61787 }];
    ...
    it('Should update editForm', () => {
      const waitingRoom: IWaitingRoom = { id: 456 };
      const attencionChannel: IWaitingRoomAttencionChannel = { id: 97608 };
      waitingRoom.attencionChannel = attencionChannel;
      const company: ICompany = { id: 50132 };
      waitingRoom.company = company;
      const branch: IBranch = { id: 60652 };
