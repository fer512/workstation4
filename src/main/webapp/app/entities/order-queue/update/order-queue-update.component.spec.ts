...
describe('OrderQueue Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Queue query and add missing value', () => {
      ...
      const queue: IQueue = { id: 53629 };
      orderQueue.queue = queue;

      const queueCollection: IQueue[] = [{ id: 77851 }];
    ...
    it('Should call WorkerProfile query and add missing value', () => {
      const orderQueue: IOrderQueue = { id: 456 };
      const workerProfile: IWorkerProfile = { id: 46315 };
      orderQueue.workerProfile = workerProfile;

      const workerProfileCollection: IWorkerProfile[] = [{ id: 65527 }];
    ...
    it('Should update editForm', () => {
      const orderQueue: IOrderQueue = { id: 456 };
      const queue: IQueue = { id: 79032 };
      orderQueue.queue = queue;
      const workerProfile: IWorkerProfile = { id: 36807 };
      orderQueue.workerProfile = workerProfile;
