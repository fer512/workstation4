...
describe('Queue Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call attencionChannel query and add missing value', () => {
      ...
      const attencionChannel: IAttencionChannel = { id: 73534 };
      queue.attencionChannel = attencionChannel;

      const attencionChannelCollection: IAttencionChannel[] = [{ id: 61672 }];
    ...
    it('Should call Company query and add missing value', () => {
      const queue: IQueue = { id: 456 };
      const company: ICompany = { id: 59510 };
      queue.company = company;

      const companyCollection: ICompany[] = [{ id: 33465 }];
    ...
    it('Should call Branch query and add missing value', () => {
      const queue: IQueue = { id: 456 };
      const branches: IBranch[] = [{ id: 64782 }];
      queue.branches = branches;

      const branchCollection: IBranch[] = [{ id: 15047 }];
    ...
    it('Should update editForm', () => {
      const queue: IQueue = { id: 456 };
      const attencionChannel: IAttencionChannel = { id: 83056 };
      queue.attencionChannel = attencionChannel;
      const company: ICompany = { id: 81737 };
      queue.company = company;
      const branch: IBranch = { id: 90835 };
