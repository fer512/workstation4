...
class WaitingRoomAttencionChannelResourceIT {
     ...
     */
    public static WaitingRoomAttencionChannel createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static WaitingRoomAttencionChannel createUpdatedEntity() {
    ...
    public void initTest() {
        waitingRoomAttencionChannelRepository.deleteAll();
        waitingRoomAttencionChannel = createEntity();
    }
    ...
    void getAllWaitingRoomAttencionChannels() throws Exception {
        ...
        waitingRoomAttencionChannelRepository.save(waitingRoomAttencionChannel);
