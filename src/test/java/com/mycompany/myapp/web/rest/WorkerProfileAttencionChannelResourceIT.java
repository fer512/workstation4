...
class WorkerProfileAttencionChannelResourceIT {
     ...
     */
    public static WorkerProfileAttencionChannel createEntity() {
     ...
     * if they test an entity which requires the current entity.
     */
    public static WorkerProfileAttencionChannel createUpdatedEntity() {
        WorkerProfileAttencionChannel workerProfileAttencionChannel = new WorkerProfileAttencionChannel()
            .name(UPDATED_NAME)
            .type(UPDATED_TYPE);
        return workerProfileAttencionChannel;
    ...
    public void initTest() {
        workerProfileAttencionChannelRepository.deleteAll();
        workerProfileAttencionChannel = createEntity();
    }
    ...
    void getAllWorkerProfileAttencionChannels() throws Exception {
        ...
        workerProfileAttencionChannelRepository.save(workerProfileAttencionChannel);
